...
public class VI_Orientation_intro extends AppCompatActivity {
    Speak sp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vi_orientation_intro);

        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        getSupportActionBar().hide();

        sp = new Speak(this.getApplicationContext());
        speak(getString(R.string.VI_Orientation_intro));
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if (done) {
                    Intent myIntent=new Intent(getApplicationContext(),VI_Orientation.class);
